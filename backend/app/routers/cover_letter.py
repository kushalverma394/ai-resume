...
from app.schemas.analysis import CoverLetterResponse, ErrorResponse
...
async def cover_letter(
    ...
    return analysis_service.build_cover_letter(extracted, job_description, company_name, role_title)